...
function Header() {
  ...
  return (
    <div>
      {/* 네비게이션 바 */}
      <nav className="navbar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 20px', borderBottom: '2px solid #007bff', backgroundColor: '#fff' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          <img src={koss1} alt="Profile" style={{ width: '40px', height: '40px' }} />
          <img src={koss2} alt="KOSS Logo" style={{ width: '60px', height: '30px' }} />
        </div>
      </nav>

      {/* 헤더 이미지 */}
      <header style={{ textAlign: 'center', padding: '20px', backgroundColor: '#29B2CC', color: '#fff', position: 'relative' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
          <img src={CharacterImageLeft} alt="Character Left" style={{ height: '250px', objectFit: 'contain' }} />
          <img src={CharacterImageCenter} alt="Character Center" style={{ height: '250px', objectFit: 'contain' }} />
      ...
      <main style={{ padding: '10px', textAlign: 'center', backgroundColor: 'white' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px', width: '80%', margin: '0 auto' }}>
